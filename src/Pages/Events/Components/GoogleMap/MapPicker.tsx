...
//   onLocationChange: (location: { latitude: string; longitude: string }, address: string) => void;
// }
...
//           onLocationChange({ latitude: String(clickedPosition.lat), longitude: String(clickedPosition.lng) }, address);
//         } else {
//           alert('Geocode was not successful for the following reason: ' + status);
//           setSearchValue(`${clickedPosition.lat}, ${clickedPosition.lng}`); // Fallback to coordinates if no address is found
//           onLocationChange({ latitude: String(clickedPosition.lat), longitude: String(clickedPosition.lng) }, `${clickedPosition.lat}, ${clickedPosition.lng}`);
//         }
//       });
