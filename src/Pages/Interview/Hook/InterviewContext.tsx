...
interface InterviewContextType {
  ...
  fetchFilteredInterviews : (
    currentPhase?: string,
    startDate?: Date,
    endDate?: Date) => Promise<Interview[]>;
...
export const InterviewProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const fetchFilteredInterviews = async (currentPhase?: string, startDate?: Date, endDate?: Date) => {
    try {
  ...
  const handleSchedule = async (
    ...
    const dateField = isReschedule ? 
      (selectedInterview.currentPhase === 'first_interview' ? 'firstInterviewDate' : 'secondInterviewDate') :
      'secondInterviewDate';
    const newPhase = isReschedule ? selectedInterview.currentPhase : 'second_interview';
