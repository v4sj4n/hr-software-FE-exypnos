...
function InterviewKanbanContent() {
  ...
  useEffect(() => {
    if (startDate && endDate) {
      ...
      console.log("Start or end date is missing. Not applying the filter.");
    }
  ...
  const filteredInterviews = interviews.filter((interview) => {
    if (currentTab === 'first_interview' && interview.currentPhase === 'first_interview') {
      return true;
    }
    if (currentTab === 'second_interview' && interview.currentPhase === 'second_interview') {
      return true;
    }
                        ...
                        >
                          ...
                          {currentTab !== 'employed' && currentTab !== 'applicant' && (
                            <>
                              ...
                              <p>
                                <b>Email</b>: {interview.email}
                              </p>
                              <p>
                                <b>Phone</b>: {interview.phoneNumber}
                              </p>
                              <p>
