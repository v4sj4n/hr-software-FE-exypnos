    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.forms}>
                ...
                <div className={style.inputWidth}>
                    <Input IsUsername  label="lastName" name="lastName" onChange={handleChange} value={user.lastName} />
                </div>
            </div>

            <div className={style.forms}>
                <div className={style.inputWidth}>
                    <Input IsUsername type="email" label="Email" name="email" onChange={handleChange} value={user.email} />
                </div>
                <div className={style.inputWidth}>
            ...
            <div className={style.border}></div>
            <div className={style.inputWidth}>
                <Button onClick={handleSignUp} type={ButtonTypes.PRIMARY} btnText='Save Changes' />
            </div>
        </div>
    )
}
