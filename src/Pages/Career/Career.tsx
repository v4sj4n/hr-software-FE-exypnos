    ...
    <div className={style.body}>
      <div className={style.container}>
        <div className={style.hero}>
          <h1>Join Our Team</h1>
          <p>
            Be part of something bigger. Make a difference in the world of
            technology.
          </p>
        </div>
          ...
          <div className={style.eventForm}>
            ...
            <form>
              ...
              <textarea
                name="description"
                value={
                  editingEvent ? editingEvent.description : event.description
                }
                onChange={editingEvent ? handleEditChange : handleChange}
        ...
        <div className={style.culture}>
          <h2>Our Culture</h2>
          <p>
            At our company, we value innovation, collaboration, and growth. Join
            us and thrive in a supportive and dynamic environment.
          </p>
        ...
        <div className={style.testimonials}>
          ...
          <p>
            "This company has provided me with numerous opportunities for growth
            and development."
          </p>
        ...
        <div className={style.footer}>
          <p>
            &copy; 2024 <a href="https://www.codevider.com/">Codevider. </a>All
            rights reserved.
          </p>
          <p>
