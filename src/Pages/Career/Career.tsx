  ...
  return (
    <div className={style.body}>
      <div className={style.container}>
        ...
        {isAdmin ? <div className={style.createButton}>
          <Button 
            btnText="New Job" 
            color='#007bff'
       ...
       {isAdmin ? <div className={style.dropdownContainer}>
          ...
          {openDropdown === event._id && (
            <div className={style.dropdownMenu}>
              ...
              <button onClick={() => handleDeleteEventModal(event._id)}>Delete</button>
            </div>
          )}
        </div> : ''}
      </div>
        ...
        <ModalComponent open={showForm} handleClose={toggleForm}>
          <div className={style.eventForm}>
            ...
            <form>
              ...
              />
              {createEventError && <p className={style.error}>{createEventError}</p>}
          ...
          <div>
            ...
            <div className={style.modalFooter}>
              <Button type={ButtonTypes.PRIMARY}
                  ...
                  borderColor='#d32f2f'
                  btnText='Confirm'
                  width='100%' onClick={() => handleDelete(eventToDeleteId)} />
              <Button btnText="Cancel"  width='100%'
              type={ButtonTypes.SECONDARY} onClick={closeModal} />
            </div>
          </div>
        </ModalComponent>
...
<img src={worker2} alt='' className={style.cultureImage}></img> 
        ...
        <div className={style.footer}>
          <p>&copy; 2024 < a href="https://www.codevider.com/">Codevider. </a>All rights reserved.</p>
