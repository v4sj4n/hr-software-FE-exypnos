  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.gridContainer}>
        <Card className={styles.mainCard} backgroundColor='rgba(255, 255, 255, 0.5)
'>
          <div className={styles.mainContent}>
            ...
            <p className={styles.description}>
              ...
              cutting-edge technologies like React, Angular, Node.js, and Python.
            </p>
          </div>
        </Card>
...
'>
          <div className={styles.mainContent}>
            ...
            <p className={styles.description}>
              At CodeVider, we believe in a collaborative approach to software development. We work 
              closely with our clients to understand their unique needs and deliver tailored solutions 
              that drive business growth and enhance user experiences.
            </p>
          </div>
        </Card>
        
        <Card className={styles.imageCard} backgroundColor='rgba(255, 255, 255, 0.5)
'>
          <img src={image} alt="CodeVider Team" className={styles.image} />
        </Card>
        
        <Card className={styles.fullWidthCard} backgroundColor='rgba(255, 255, 255, 0.5)
'>
          <h2 className={styles.cardTitle}>Our Mission</h2>
          <p className={styles.description}>To deliver innovative and efficient web solutions that drive business growth and user satisfaction.</p>
        </Card>
      </div>
